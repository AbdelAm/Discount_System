=> The solution is about a system that manage Discount Codes, it generates discount codes and check if the discount code provided by the user is valid or not
